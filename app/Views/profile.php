      <div class="content-body">
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url('javascript:void(0)')?>">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="<?= base_url('javascript:void(0)')?>">Home</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    <img class="mr-3" src="<?= base_url('assets/images/user/1.png')?>" width="80" height="80" alt="">
                                    <div class="media-body">
                                        <h3 class="mb-0">mey</h3>
