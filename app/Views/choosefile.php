        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= base_url('home/coba11') ?>" method="post">
                <div class="container">
    <h1 class="mt-5">Upload Image</h1>
    <form id="imageForm" action="preview.html" method="POST" enctype="multipart/form-data">
      <div class="form-group">
        <label for="inputText">Name</label>
        <input type="text" class="form-control" id="inputText" name="name" placeholder="Enter name">
      </div>
      <div class="form-group">
