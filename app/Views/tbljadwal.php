                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success mb-3">
                            <a href="/home/forminputjadwal" class="text-white">Tambah</a>
                        </button>
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('Home/edit_jadwal/'.$value->id_jadwal)?>" class="btn btn-warning">Edit</a>
                                        <a href="<?= base_url('Home/hapus_jadwal/'.$value->id_jadwal)?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
