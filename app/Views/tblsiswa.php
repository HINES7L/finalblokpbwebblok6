                ...
                <div class="col-lg-12">
                    <div class="card p-4">
                        <button class="btn btn-success mb-3">
                            <a href="/home/forminputsiswa" class="text-white text-decoration-none">Tambah</a>
                        </button>
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('home/generatesiswa/'.$value->nis) ?>" class="btn btn-info">
                                            <i class="material-symbols-rounded">qr_code_scanner</i>
                                        </a>
                                        <a href="<?= base_url('Home/edit_siswa/'.$value->id_siswa) ?>" class="btn btn-warning">Edit</a>
                                        <a href="<?= base_url('Home/hapus_siswa/'.$value->id_siswa) ?>" class="btn btn-danger">Hapus</a>
                                        <a href="<?= base_url('Home/detailsiswa/'.$value->id_siswa) ?>" class="btn btn-info">Detail</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
