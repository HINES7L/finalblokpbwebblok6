...
<h3>Laporan keluar</h3>
  <form action="<?= base_url('home/lapbr') ?>" method="post" target="_blank">
  ...
  <div class="row">
    ...
    <div class="col" class="form-control">
  <a href="<?= base_url('home/lapbr/')?>"><button type="print" class="btn btn-primary" ?>
  <i class="fas fa-print"></i>
            Cetak
           </button></a> 
       </div>
</form>
  <form action="<?= base_url('home/downloadPDFr') ?>" method="post"  target="_blank">
    <div class="mt-3">
    <div class="row">
    <div class="col">
      <label for="awal" class="form-label">tanggal awal:</label>
  ...
  <div class="row">
    ...
    <div class="col" class="form-control">
  <a href="<?= base_url('home/downloadPDFr/')?>"><button type="submit" class="btn btn-danger" ?>
...
<form class="mt-4" action="<?= base_url('home/excellapor_br')?>" method="POST">
     <div class="mb-3">
    <div class="row">
        <div class="col">
