                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- <button class="btn btn-success mb-3">
                            <a href="/home/forminputabsensisiswa" class="text-white">Tambah</a>
                        </button> -->
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value->status    ?></td>
                                    <td>
                                        <a href="<?= base_url('Home/edit_absensisiswa/'.$value->id_absensiswa)?>" class="btn btn-warning">Edit</a>
                                        <!-- <a href="<?= base_url('Home/hapus_absensisiswa/'.$value->id_absensiswa)?>" class="btn btn-danger">Hapus</a> -->
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
