...
<div class="container">
    ...
    <form action="<?= base_url('home/simpan_kelas') ?>" method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_kelas" placeholder="Enter nama_kelas" name="nama_kelas" value="<?= $resdi->nama_kelas ?>">
        </div>
        <input type="hidden" value="<?= $resdi->id_kelas ?>" name="id">
