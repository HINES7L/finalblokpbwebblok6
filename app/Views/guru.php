...
<div class="container">
    ...
    <form action="<?= base_url('home/simpan_guru') ?>" method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_guru" placeholder="Enter nama_guru" name="nama_guru" value="<?= $resdi->nama_guru ?>">
        </div>
        <div class="mb-3">
            <label for="nik" class="form-label">NIK:</label>
            <input type="text" class="form-control" id="nik" placeholder="Enter nik" name="nik" value="<?= $resdi->nik ?>">
        </div>
        <input type="hidden" value="<?= $resdi->id_guru ?>" name="id">
        <label></label>
